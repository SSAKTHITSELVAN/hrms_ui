...
// import React, { useState, useEffect } from 'react';
// import MobileDashboardLayout from '../layouts/MobileDashboardLayout'; // Import MobileDashboardLayout
// // import LaptopDashboardLayout from '../layouts/LaptopDashboardLayout'; // This line is now removed
...
// const ResponsiveDashboardLayout = ({ children }) => {
//   const { width } = useWindowSize();
//   // const [isMobile, setIsMobile] = useState(false); // This state is no longer strictly needed for layout switching
...
//   // Always render MobileDashboardLayout, and pass `width` if needed for internal styling
//   return (
//     <MobileDashboardLayout currentWidth={width} mobileBreakpoint={MOBILE_BREAKPOINT}>
//       {children}
...
const ResponsiveDashboardLayout = ({ children }) => {
  ...
  // Always render MobileDashboardLayout, and pass width and breakpoint
  return (
    <MobileDashboardLayout currentWidth={width} mobileBreakpoint={MOBILE_BREAKPOINT}>
      {children}
    </MobileDashboardLayout>
